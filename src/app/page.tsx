        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6">
            {[
              ...
              { name: 'Projects', icon: FaBook, itemCount: '1,240+ items', bgGradient: 'from-blue-600 to-blue-700', iconColor: 'text-blue-300', hoverGradient: 'from-blue-500 to-blue-600', accentColor: 'from-blue-400/20 to-blue-500/20' },
