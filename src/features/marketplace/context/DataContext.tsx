...
const addProduct = (
  productData: Omit<Product, 'id' | 'createdAt' | 'views' | 'likes'>
) => {
  const category =
    detectCategoryFromTitle(productData.title) || productData.category;
  ...
  const newProduct: Product = {
    ...
    campus: productData.campus || 'RVCE',

    hostel: productData.hostel || 'Hostel D',
